...
function atualizar(){
    ...
    $.ajax({
        type: 'PUT',
        url: 'https://localhost:5001/Avaliacao/Alterar',
...
function listarGridDecrescente(){
    $.get('https://localhost:5001/Disciplina/Listar?order=d')
        .done(function(resposta) { 
            grid(resposta);
        })
        .fail(function(erro, mensagem, excecao) { 
...
function listarGridCrescente(){
    $.get('https://localhost:5001/Disciplina/Listar?order=c')
        .done(function(resposta) { 
            grid(resposta);
        })
        .fail(function(erro, mensagem, excecao) { 
...
function listaAvaliacaoPorDisciplina() {
    ...
    {
        $.get('https://localhost:5001/Disciplina/ListarPorDisciplina?nome=' + textAvaliacao)
            .done(function(resposta) { 
                grid(resposta);
            })
            .fail(function(erro, mensagem, excecao) { 
...
function listarDisciplina(){
    $.get('https://localhost:5001/Avaliacao/ListarDisciplina')
        .done(function(resposta) { 
            for(i = 0; i < resposta.length; i++) {
