...
namespace ProjetoIntegrador.Models
{
    public partial class BDContexto : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("Server=localhost;Port=3306;User=root;Password=Lucas1122;Database=Jschool", Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.5.62-mysql"));
            }
        }
